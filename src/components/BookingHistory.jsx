            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              ...
              <div className="flex gap-2 sm:gap-3 flex-wrap">
                <button
                  ...
                  className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 shadow-sm ${filterType === 'all'
                ...
                <button
                  ...
                  className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 shadow-sm ${filterType === 'paid'
                      ? 'bg-green-600 text-white shadow-md scale-105'
                      : 'bg-white border-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-green-400'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 shadow-sm ${filterType === 'pending'
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                          ...
                          {booking.paymentStatus === 'paid' ? (
                            ...
                            <button
                              ...
                              className="px-3 py-1.5 sm:px-4 sm:py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all transform hover:scale-105 shadow-md flex items-center gap-1.5 text-xs font-bold flex-shrink-0"
                            >
